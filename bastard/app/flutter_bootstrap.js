...
// `serviceWorkerSettings` to the loader. Instead we register our own
// hand-rolled `sw.js` below (see web/sw.js). The precache manifest is
// injected post-build by tool/inject_sw_manifest.py.
